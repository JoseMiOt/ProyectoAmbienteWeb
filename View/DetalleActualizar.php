...
<head>
  <!-- title -->
  <title>Actualizar Detalles Factura</title>
      ...
      <div class="row">
        <div class="col-lg-8 offset-lg-2 text-center">
          <div class="breadcrumb-text">
            <p>Actualiza la información de los detalles de la factura</p>
...
<div class="container">
  <?php
        ...
        if ($result = ConsultarDetalleID($id_detalle_factura)) {
        ?>
                ...
                <form action = "" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4"><b>ID</b>
                            ...
                            <?php echo htmlentities($result['id_detalle_factura']); ?>"
                ...
                <div class="row" style="margin-top:1%">
                    <div class="col-md-8">
                        <input type="submit" name="update-detalle" value="Actualizar">
                    </div>
                </div>
                </form>
            </div>
