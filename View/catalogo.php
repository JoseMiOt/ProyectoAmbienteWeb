		...
		<div class="container">
			...
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="producto.php"><img src="../assets/img/products/producto-img-1.png" alt=""></a>
						</div>
						<h3>Alcohol 250ml</h3>
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="producto.php"><img src="../assets/img/products/producto-img-2.jpg" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 text-center lemon">
					<div class="single-product-item">
						<div class="product-image">
							<a href="producto.php"><img src="../assets/img/products/producto-img-3.png" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="producto.php"><img src="../assets/img/products/producto-img-4.jpg" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="producto.php"><img src="../assets/img/products/producto-img-5.png" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="producto.php"><img src="../assets/img/products/producto-img-6.jpg" alt=""></a>
						</div>
